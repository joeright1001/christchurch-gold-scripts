...
# Central build script that can be called from any directory within the git repository.
param(
...
if (-not (Test-Path $TargetDirectory)) {
    Write-Host "Error: Target directory '$TargetDirectory' does not exist!" -ForegroundColor Red
    return
}
